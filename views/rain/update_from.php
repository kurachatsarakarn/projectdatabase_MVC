...
<body>
    ...
    <br><label>วันที่บันทึก<input type="date" name="date" value="<?php echo $r->date;?>"/></label><br>
    <br><label for="">ปริมาตรน้ำฝน<input type="text" name="rainvolume" value="<?php echo $r->rainvolume;?>"/></label><br>
    <br><label for="">พื้นที่ครอบคลุม<input type="text" name="areapercent" value="<?php echo $r->areapercent;?>"/></label><br>
    <input type="hidden" name="controller" value="rain"/><br>
    <br><button type="submit" name="action" value="index">back</button>   
    <button type="submit" name="action" value="update">update</button>
    <input type="hidden" name="RID" value="<?php echo $r->rainID?>"/><br>
    </form>
